...
macro(checkandset_dependency package)
  ...
  elseif (${PREFIX}_USE_${package})
    set(BLF_CMAKE_MODULE_PATH_BACKUP "${CMAKE_MODULE_PATH}")
    if (CSD_COMPONENTS AND CSD_OPTIONAL_COMPONENTS)
      find_package(${package} ${CSD_MINIMUM_VERSION} COMPONENTS ${CSD_COMPONENTS}
                   OPTIONAL_COMPONENTS ${CSD_OPTIONAL_COMPONENTS} REQUIRED)
    elseif (CSD_COMPONENTS)
      find_package(${package} ${CSD_MINIMUM_VERSION} COMPONENTS ${CSD_COMPONENTS} REQUIRED)
    elseif (CSD_OPTIONAL_COMPONENTS)
      find_package(${package} ${CSD_MINIMUM_VERSION} OPTIONAL_COMPONENTS ${CSD_OPTIONAL_COMPONENTS} REQUIRED)
    else ()
